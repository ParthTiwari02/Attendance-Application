...
<MainMenu>:
    ...
    GridLayout:
        ...
        rows:3
        Image:
            source: 'C:/Users/asus/Downloads/Attendance_image.png'
            size_hint: 17,2
        Button:
            text: "About"
...
class About(Screen):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.l1 = Label(text="This is face recognition based attendance system.\n "
                             "It is Based on Histogram of oriented Gradients.\n"
                             "This Application can be very helpful for marking \n attendance rather than traditional ways.\n",color=(0.5,0,0.5,1),halign="center",font_size = '20sp')
